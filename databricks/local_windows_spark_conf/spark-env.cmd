...
@REM # Copy it as spark-env.sh and edit that to configure Spark for your site.
...
@REM service principal env variables
set TENANT_ID=abcd
set CLIENT_ID=id
set CLIENT_SECRET=secret
set ATLAS_CLIENT_TYPE=rest
set ATLAS_REST_ADDRESS=https://test.catalog.purview.azure.com
