...
import com.sparkview.spark.atlas.AtlasClientConf.ConfigEntry

// custom java classes
import com.sparkview.atlas.ApplicationProperties
...
object AtlasClientConf {
  ...
  // originally localhost:21000
  // TODO determine what should default be. might be client dependant
  ...
  // default as rest for purview
  val CLIENT_TYPE = ConfigEntry("atlas.client.type", sys.env.getOrElse("ATLAS_CLIENT_TYPE", "rest"))
