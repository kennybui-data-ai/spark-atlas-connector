...
package com.sparkview.spark.atlas.sql
...
import com.sparkview.spark.atlas.{AtlasClientConf, SACAtlasEntityWithDependencies, SACAtlasReferenceable}
import com.sparkview.spark.atlas.sql.SparkExecutionPlanProcessor.SinkDataSourceWriter
import com.sparkview.spark.atlas.types.{AtlasEntityUtils, external, internal}
import com.sparkview.spark.atlas.utils.SparkUtils.sparkSession
import com.sparkview.spark.atlas.utils.{Logging, SparkUtils}
  ...
  object HWCEntities extends Logging {
    ...
    object HWCSupport {
      val BATCH_READ_SOURCE =
        "com.sparkview.spark.sql.hive.llap.HiveWarehouseConnector"
      val BATCH_WRITE =
        "com.sparkview.spark.sql.hive.llap.HiveWarehouseDataSourceWriter"
      val BATCH_STREAM_WRITE =
        "com.sparkview.spark.sql.hive.llap.HiveStreamingDataSourceWriter"
      val STREAM_WRITE =
        "com.sparkview.spark.sql.hive.llap.streaming.HiveStreamingDataSourceWriter"
